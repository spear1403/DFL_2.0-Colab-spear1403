if __name__ == "__main__":
    ...
    def process_merge(arguments):
        ...
        Merger.main ( model_class_name       = arguments.model_name,
                      ...
                      mask_mode_name         = arguments.mask_mode_name,
                      erode_mask             = arguments.erode_mask,
                      blur_mask             = arguments.blur_mask)
    ...
    p.add_argument('--force-gpu-idxs', dest="force_gpu_idxs", default=None, help="Force to choose GPU indexes separated by comma.")
    p.add_argument('--silent-start', action="store_true", dest="silent_start", default=False, help="Silent start. Automatically chooses Best GPU and last used model.")
    p.add_argument('--mode', dest="mode_name")
    p.add_argument('--mask_mode', dest="mask_mode_name")
    p.add_argument('--erode-mask', type=int, dest="erode_mask")
    p.add_argument('--blur-mask', type=int, dest="blur_mask")
